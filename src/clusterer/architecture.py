"""
Architecture from https://github.com/R4j4n/Face-recognition-Using-Facenet-On-Tensorflow-2.X/tree/master
"""
...
if __name__ == '__main__':
    ...
    path = os.path.join(cwd, "model_data/facenet_keras_weights.h5")
